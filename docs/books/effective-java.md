...
## :material-bookshelf: Book Structure

| Chapter | Items | Related Notes |
|---------|-------|---------------|
| Creating and Destroying Objects | 1-9 | [OOP & Class Design](../notes/phase-1/topic-2-oop-class-design/book-reading.md) |
| Methods Common to All Objects | 10-14 | [OOP & Class Design](../notes/phase-1/topic-2-oop-class-design/book-reading.md) |
...
## :material-target: Phase 1 Items to Focus On
...
## :material-book-open-variant: Reading Strategy
...
<!-- Add your chapter-by-chapter notes here, or use the linked topic-specific book-reading.md files -->
