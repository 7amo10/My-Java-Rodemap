...
| [Topic 2: OOP & Class Design](phase-1/topic-2-oop-class-design/index.md) | Classes, inheritance, polymorphism, abstraction, composition | :material-circle-outline: |
| [Topic 3: Arrays, Lists & Generics](phase-1/topic-3-arrays-lists-generics/index.md) | Arrays, ArrayList, LinkedList, Generics, Wildcards | :material-circle-outline: |
| [Topic 4: Lambdas & Streams](phase-1/topic-4-lambdas-streams/index.md) | Lambda expressions, Stream API, Optional, Method References | :material-circle-outline: |
| [Topic 5: Collections Framework](phase-1/topic-5-collections-framework/index.md) | List, Set, Map, Queue implementations, internals | :material-circle-outline: |
